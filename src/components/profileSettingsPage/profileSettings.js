...
const ProfileSettings = () => {
    ...
    function gettingProfileData() {
        ...
        axios.post(API_URL, { phone, password }, { headers })
            .then((response) => {
                setProfileSettingsData(response.data);
                console.log(response.data);
            });
    }

    function includeData() {
        document.getElementById('phone-input').value = profileSettingsData.phone;
        document.getElementById('email-input').value = profileSettingsData.mail;
        document.getElementById('vk-input').value = profileSettingsData.facebook;
        document.getElementById('password-input').value = profileSettingsData.password;
    }
                ...
                <form action="#" className={ProfileSettingsCSS.profile_settings__container}>
                    ...
                    <div className={ProfileSettingsCSS.profile__data}>
                        <label className={ProfileSettingsCSS.phone_label} htmlFor="phone-input">
                            ...
                            <input onFocus={loginInputMask} className={ProfileSettingsCSS.phone__input + " input"} type="text" name="phone" placeholder="+7(900)000-00-00" id="phone-input" />
                        </label>
                        ...
                        <label className={ProfileSettingsCSS.email_label} htmlFor="email-input">
                            ...
                            <input className={ProfileSettingsCSS.email__input + " input"} type="text" name="email" placeholder="gg@yandex.ru" id="email-input" />
                        </label>
