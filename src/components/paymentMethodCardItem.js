...
import PaymentMetCardItemCSS from './css/paymentMethod.module.css';

const PaymentMetCardItem = props => ( 
    <li id={props.number} className={PaymentMetCardItemCSS.payment_list__item}>
        <NavLink to="/viev-card">
            <input className={PaymentMetCardItemCSS.payment_input + " visually-hidden"} type="radio" name="payment-method" value="first-card" id="first-card" />
            <label className={PaymentMetCardItemCSS.payment_label} htmlFor="first-card">
                ...
                <span className={PaymentMetCardItemCSS.payment_name}>{props.owner}</span>
                <span className={PaymentMetCardItemCSS.payment_date}>{props.date}</span>
                <span className={PaymentMetCardItemCSS.payment_numbers}>{props.number.substring(0, 7)}</span>
            </label>
        </NavLink>
    </li>
);

export default PaymentMetCardItem;