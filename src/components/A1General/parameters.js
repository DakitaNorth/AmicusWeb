    ...
    render() {
        return (
            <div className={ParametersCSS.parameters}>
                <ul className={ParametersCSS.parameters__list}>
                    <li className={ParametersCSS.parameters__item}>
                        <NavLink to="/days-parameter" className={ParametersCSS.days_item} href="#">
                    ...
                    <li className={ParametersCSS.parameters__item}>
                        <NavLink to="/human-parameter" className={ParametersCSS.human_item} href="#">
                            ...
                            {this.state.humanData}
                        </NavLink>
                    </li>
                    <li className={ParametersCSS.parameters__item}>
                        <NavLink to="/time-parameter" className={ParametersCSS.time_item} href="#">
                            ...
                            <span className={ParametersCSS.time_text}>{this.state.departureTime}</span>
                            <span className={ParametersCSS.time_text}>{this.state.arrivalTime}</span>
                        </NavLink>
                    </li>
                </ul>
            </div>
