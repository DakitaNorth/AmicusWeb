                ...
                <section className={ProfileCSS.my_profile}>
                    <div className={ProfileCSS.my_profile__container}>
                        <div className={ProfileCSS.my_profile__avatar + " " + ProfileCSS.avatar}>
                            <button className={ProfileCSS.avatar__load_button}>
                                <img className={ProfileCSS.avatar__img} src={this.state.profileData.photo} width="85" height="85" alt="Ваш аватар" />
                            </button>
                            <span className={ProfileCSS.avatar__name}>{this.state.profileData.name}</span>
                            <span className={ProfileCSS.avatar__email}>{this.state.profileData.mail}</span>
                        </div>
                        <ul className={ProfileCSS.my_profile__setting_list + " " + ProfileCSS.setting_list}>
                            ...
                            <li>
                                <NavLink to="/my-servics-settings" className={ProfileCSS.setting_list__item}>
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="20" cy="20" r="20" fill="#476DF5" />
