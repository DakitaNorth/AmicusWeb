...
import CreateParametersCSS from './css/createParameters.module.css';
...
const CreateParameters = () => {
    ...
    return (
        <div className={CreateParametersCSS.parameters}>
            <ul className={CreateParametersCSS.parameters__list}>
                <li className={CreateParametersCSS.parameters__item}>
                    <NavLink to="/create-days-parameter" className={CreateParametersCSS.days_item} href="#">
                ...
                <li className={CreateParametersCSS.parameters__item}>
                    <NavLink to="/create-human-parameter" className={CreateParametersCSS.human_item} href="#">
                ...
                <li className={CreateParametersCSS.parameters__item}>
                    <NavLink to="/create-time-parameter" className={CreateParametersCSS.time_item} href="#">
                        ...
                        <span className={CreateParametersCSS.time_text}>{departureTime}</span>
                        <span className={CreateParametersCSS.time_text}>{arrivalTime}</span>
                    </NavLink>
                </li>
            </ul>
        </div>
