...
class VievCard extends Component {
        ...
        return (
            <div className="universal-form">
                ...
                <section className={VievCardCSS.form_card_viev}>
                    <div className={VievCardCSS.form_card_viev__container}>
                        <form className={VievCardCSS.form_card_viev__wrapper} action="#">
                            ...
                            <label className={VievCardCSS.form_label_num} htmlfor="num-card">
                                ...
                                <span className={VievCardCSS.form__input + " " + VievCardCSS.form__input_num} id="num-card">{this.state.cardData.number}</span>
                            </label>
                            <div className={VievCardCSS.form_card_viev__shield}>
                                <label className={VievCardCSS.form_label_date} htmlfor="date-card">
                                    ...
                                    <span className={VievCardCSS.form__input + " " + VievCardCSS.form__input_date} id="date-card">{this.state.cardData.date}</span>
                                </label>
                                <label className={VievCardCSS.form_label_cvv} htmlfor="cvv-card">
                                    <span className={VievCardCSS.form_input__text}>CVV-код</span>
                                    <span className={VievCardCSS.form__input + " " + VievCardCSS.form__input_cvv} id="cvv-card">{this.state.cardData.cvv}</span>
                                </label>
                            </div>
                            <span className={VievCardCSS.form__input + " " + VievCardCSS.form__input_name} id="name-card">{this.state.cardData.owner}</span>
                        </form>
                    ...
                    <button className={VievCardCSS.viev_card__button + " button"}>Сохранить</button>
                </section>
            </div>
        )
    }
